...
export default function StarRating({ maxRating = 4,color='#fcc419',size=48, className='' ,message=[] ,defaultRating=0,onSetRating}) {
...
// export default function StarRating({maxRating,message=[]}){
...
//       {array=Array.from({length:5},(_,i) => <Star onRate={() => setRating(i+1)} full={ tempRating ? tempRating >= i+1 :rating >=i+1} onHoverIn={() => setTemprating(i+1)} onHoverOut={() =>setTemprating(0)}/> )}
...
//       {full ?<svg style={starStyle1} 
//       xmlns="http://www.w3.org/2000/svg"
//       viewBox="0 0 20 20"
//       fill={starStyle1.color}
//        stroke={starStyle1.color}
// >
//   <path
//     d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"
//   />
// </svg> :
//  <svg style={starStyle1}
//    xmlns="http://www.w3.org/2000/svg"
//    fill="none"
//    viewBox="0 0 24 24"
//    stroke={starStyle1.color}
